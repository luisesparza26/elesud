...
<body>
	@include('btn-elevator') @include ('partials.nav-trans') @yield('content')
			...
			<div class="row">
				...
				<div class="col-lg-6 py-3">
					<div class="contact-layer">
						<p><img class="mr-2" src="{{ asset('img/index/email.svg') }}" alt="icon" width="30">ventas@elesud.com</p>
						<p><img class="mr-2" src="{{ asset('img/index/phone.svg') }}" alt="icon" width="30">(+51) 975148573</p>
						<p><img class="mr-2" src="{{ asset('img/index/map.svg') }}" alt="icon" width="30">Víctor Maurtua 166, LIMA 18</p>
						<div class="fb-like py-2" data-href="https://www.facebook.com/ELESUDPERU/" data-layout="button_count" data-action="like" data-size="small" data-show-faces="false" data-share="true"></div>
						<div class="map-responsive py-4">
