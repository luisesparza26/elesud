				...
				<div id="carousel-products" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="w-100" src="{{ asset('img/products-all/industriales/'.$product->imagen_1 )}}" alt="product">
						</div>
						<!---<div class="carousel-item">
							<img class="w-100" src="{{ asset('img/products-all/industriales/'.$product->imagen_2 )}}" alt="product">
						</div>
						<div class="carousel-item">
							<img class="w-100" src="{{ asset('img/products-all/industriales/'.$product->imagen_3 )}}" alt="product">
						</div>-->
					</div>
